...
public enum UserResponseCode implements ResponseCode {
    ...
    PASSWORD_VERIFY_SUCCESS(HttpStatus.OK, "USER_PASSWORD_VERIFY_SUCCESS"),
    PASSWORD_CHANGE_SUCCESS(HttpStatus.OK, "USER_PASSWORD_CHANGE_SUCCESS"),

    // 실패
    NOT_MATCHED_PASSWORD(HttpStatus.BAD_REQUEST, "USER_NOT_MATCHED_PASSWORD"),
    NEED_PASSWORD_CHECK(HttpStatus.BAD_REQUEST, "USER_NEED_PASSWORD_CHECK"),
